  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className="absolute top-4 right-4 z-20 p-2 bg-midnight-surface border border-midnight-border rounded-lg text-midnight-muted hover:text-white hover:bg-midnight-surface/80 transition-colors lg:block hidden"
      ...
      <div
        className={`
          hidden lg:flex flex-col h-full bg-midnight-bg border-l border-midnight-border transition-all duration-300
        ...
        <div className="p-4 border-b border-midnight-border flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-1.5 bg-midnight-accent text-white rounded-lg hover:bg-midnight-accentHover transition-colors"
              title="New chat"
            >
